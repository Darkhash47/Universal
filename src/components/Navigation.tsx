    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 w-full z-50 bg-[#050505] border-b border-white/5 p-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-white tracking-tighter uppercase italic">Institutional</span>
        </Link>
        <button 
        ...
        {(isOpen || window.innerWidth >= 1024) && (
          ...
          >
            ...
            <div className="flex-1 space-y-1 overflow-y-auto no-scrollbar pr-2">
              ...
              <NavItem to="/dashboard" icon={<Terminal className="w-4 h-4" />} label="Dashboard" />
              ...
              <NavItem to="/academy" icon={<GraduationCap className="w-4 h-4" />} label="Courses" />
              ...
              <div className="pt-6 pb-2 text-[9px] font-bold text-white/20 uppercase tracking-[0.2em] px-4">User Network</div>
