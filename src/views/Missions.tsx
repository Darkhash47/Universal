...
export const Missions = () => {
  ...
  return (
    <div className="space-y-12 pb-32">
      <TechHeader title="Operational Missions" subtitle="Active Assignments & Weekly Challenges" />
        ...
        <div className="lg:col-span-2 space-y-6">
          {loading ? (
            ...
            <div className="text-center py-20 bg-white/[0.02] rounded-[3rem] border border-dashed border-white/5">
              ...
              <p className="text-white/20 font-mono text-xs uppercase tracking-widest">No active missions in current cycle</p>
            </div>
          ) : (
            tasks.map((task) => {
